...
import (
	...
	cpu "github.com/shellvish/gopsutil/v3/cpu"
	"github.com/shellvish/gopsutil/v3/internal/common"
	mem "github.com/shellvish/gopsutil/v3/mem"
	net "github.com/shellvish/gopsutil/v3/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/shellvish/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
