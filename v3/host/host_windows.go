...
import (
	...
	"github.com/shellvish/gopsutil/v3/process"
...
func HostIDWithContext(ctx context.Context) (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://github.com/shellvish/gopsutil/pull/312#issuecomment-277422612
